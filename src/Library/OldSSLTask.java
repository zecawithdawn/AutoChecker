...
import com.example.kyh.real.Library.SFSSLSocketFactory;import org.apache.http.HttpResponse;
 ...
 */
public class OldSSLTask extends AsyncTask<Void, Void, JSONObject> {

    String urlPath;
    JSONObject json;
    ClientConnectionManager ccm;

    public OldSSLTask(String urlPath, JSONObject json) {
    ...
    private HttpClient getHttpClient() {
        try {
            ...
            HttpClient dhc = new DefaultHttpClient(ccm, params);
